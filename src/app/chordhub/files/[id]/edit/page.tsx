...
export default function Page(){
    ...
    useEffect(()=>{
        ...
        axios.get(`${routeClient()}/api/auth/files/${id}`).then((res:any)=>{
            const file = res.data
            console.log(file)
            setListSongs(file.songs)
            setListInfo(file)
        })
    },[id])
    ...
    const handleSubmit = (e:any)=>{
        ...
        axios.patch(`${routeClient()}/api/auth/files/${id}/update`,fileCredentials, {headers:{
    ...
    return <div className="flex flex-col gap-5">
        <h1 className="text-3xl font-bold">Actualizar Cancionero</h1>
        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            <div className="sm:col-span-1">
                ...
                <Input
                    ...
                    .max(45)
                    .regex(/^[A-Za-z]/)}
                    defaultValue={listInfo && listInfo.name}
                    name="name"
            ...
            <button className="p-2 rounded-lg bg-green-600 text-white">Actualizar</button>
